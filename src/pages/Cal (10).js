...
const Cal = (props) => {
    ...
    const handleDropdownSelectTwo = (item) => {
    ...
    return (
        <div>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <FormGroup>
                    <Label for="time">Time: {selectedItemTwo}</Label>
                    <Dropdown isOpen={dropdownOpentwo} toggle={toggleDropdowntwo}>
                        <DropdownToggle caret style={{ color: "white" }}>
                            {selectedItemTwo || "Select a vet"}
                        </DropdownToggle>
                        <DropdownMenu>
                            {vetInfoTable && vetInfoTable.map((item, index) => (
                                 (
                                    <DropdownItem key={index} onClick={() => handleDropdownSelectTwo(item)}>
                                        {item}
                                    </DropdownItem>
                                )
                            ))}
