...
function SignUp(props) {
    //const { email, password, address, city, userState, zip, id, userType, phone } = props.user;
    const { user } = props;
    ...
    const handleUserUpdate = (event) => {
        ...
        setUserState(document.getElementById('exampleState').value);
    ...
    const handleUserDeconstruction = (event) => {
        event.preventDefault();
        const { email, password, address, city, userState, zip, id, userType, phone } = user;
    };
