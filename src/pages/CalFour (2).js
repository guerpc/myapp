...
const CalFour = (props) => {
  ...
  const handleDropdownSelectTwo = (vetId) => {
    ...
    function ShowPetRecordInfo(petRecordsInfoTableTarget, selectedItem ) {
        const petRecordsInfo = UsePetRecordsInfoTableTarget(petRecordsInfoTableTarget);
    ...
    return (
        <div>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <ShowPetRecordInfo petRecordsInfoTableTarget={petRecordsInfoTableTarget} selectedItem={selectedItem} />
