            ...
            <Form onSubmit={handleSubmit}>
                ...
                <FormGroup>
                    ...
                    <Dropdown isOpen={dropdownOpenthree} toggle={toggleDropdownthree}>
                        <DropdownToggle caret style={{ color: "white" }}>
                            {selectedItem
                                ? `${selectedItem} - ${selectedPetID} - ${selectedPetName}`
                                : "Select a Pet"}
                        </DropdownToggle>
                        <DropdownMenu>
                            {petInfoTable && listOfIDs.map((pet) => (
                                <DropdownItem
                                    key={pet.PetID}
                                    onClick={() => handleDropdownSelectThree(pet.PetID)}
                                >
                                    {`${pet.selectedPetID} ${pet.selectedPetName} Pet Owner UserID:${pet.selectedPetOwnerID}`}
                                </DropdownItem>
                            ))}
                        </DropdownMenu>
                    </Dropdown>
